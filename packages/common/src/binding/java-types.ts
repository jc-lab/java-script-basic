...
interface BlockingDequeStatic {

	readonly class:any;
}

export const BlockingDeque: BlockingDequeStatic = Packages.java.util.concurrent.BlockingDeque;


interface BlockingQueueStatic {

	readonly class:any;
}

export const BlockingQueue: BlockingQueueStatic = Packages.java.util.concurrent.BlockingQueue;
...
interface CompletableFutureStatic {
	...
	supplyAsync<U>( arg0:Supplier<U>, arg1:any /*java.util.concurrent.Executor*/ ):java.util.concurrent.CompletableFuture<U>;
	...
	runAsync( arg0:java.lang.Runnable, arg1:any /*java.util.concurrent.Executor*/ ):java.util.concurrent.CompletableFuture<void>;
	delayedExecutor( arg0:long, arg1:any /*java.util.concurrent.TimeUnit*/ ):any /*java.util.concurrent.Executor*/;
	delayedExecutor( arg0:long, arg1:any /*java.util.concurrent.TimeUnit*/, arg2:any /*java.util.concurrent.Executor*/ ):any /*java.util.concurrent.Executor*/;
}

export const CompletableFuture: CompletableFutureStatic = Packages.java.util.concurrent.CompletableFuture;
...
export const LinkedBlockingDeque: LinkedBlockingDequeStatic = Packages.java.util.concurrent.LinkedBlockingDeque;


interface LinkedBlockingQueueStatic {

	readonly class:any;
	new<E>( arg0:int ):java.util.concurrent.LinkedBlockingQueue<E>;
	new<E>(  ):java.util.concurrent.LinkedBlockingQueue<E>;
	new<E>( arg0:java.util.Collection<E> ):java.util.concurrent.LinkedBlockingQueue<E>;
}

export const LinkedBlockingQueue: LinkedBlockingQueueStatic = Packages.java.util.concurrent.LinkedBlockingQueue;
